...
export interface VisualPreset {
  ...
  /** Which group this sits in, so twenty tiles stay scannable. */
  family: 'Loud' | 'Quiet' | 'Photographic' | 'Graphic'
  /** How the preview tile draws itself. Twenty coloured rectangles communicate
   *  almost nothing; a gradient, a flat block, a photo frame, a grid and a paper
   *  sheet read as five different kinds of image at a glance. */
  previewShape: 'gradient' | 'flat' | 'photo' | 'grid' | 'paper'
...
export const VISUAL_PRESETS: VisualPreset[] = [
  ...
  // ── Twelve more, added when eight was not enough range ────────────────────
  //
  // Spread deliberately across four axes rather than eight variations of one
  // idea: how loud it is, whether it is photographic or graphic, what era it
  // borrows from, and how the product is lit. Two presets that differ only in
  // adjective produce the same image, so the suite checks every pair.
  {
    id: 'neon',
    name: 'Neon night',
    family: 'Loud',
    previewShape: 'gradient',
    blurb: 'Electric colour on black, wet reflections. Loud, but nothing like Bold.',
    direction: 'Night-time neon scene. The product lit by coloured tube signage and spill light, sitting on a wet reflective surface that throws the colour back. Deep black everywhere the light does not reach. Loud, but through colour and light rather than graphics.',
    typography: 'Glowing tube-style or hard-edged sans type, set as if it were a sign in the scene rather than pasted over it.',
    background: 'Black, with magenta and cyan neon spill, soft bloom and a wet floor reflection.',
    badges: true,
    fallbackPalette: 'magenta and cyan neon on black',
    swatch: ['#080510', '#F2F2F7', '#FF2D9B'],
    previewWeight: 800,
    previewSerif: false,
  },
  {
    ...
    family: 'Quiet',
    previewShape: 'flat',
    blurb: 'Airy, light and pale. Beauty, wellness, home and anything gentle.',
    direction: 'Soft pastel still life. Very light throughout, with gentle diffused shadows and no hard edges anywhere. Calm and unhurried, closer to a skincare campaign than a product review.',
    typography: 'A light-weight sans in a soft tone rather than black, small and placed with room around it.',
    background: 'A pale pastel field, optionally with a soft paper or fabric texture and a long gentle shadow.',
    badges: false,
    fallbackPalette: 'pale blush, sky and cream, nothing saturated',
    swatch: ['#F6E8EE', '#5A4E55', '#A8C8D8'],
    previewWeight: 300,
    previewSerif: false,
  },
  {
    ...
    family: 'Graphic',
    previewShape: 'flat',
    blurb: 'Flat shapes and primary colour. Graphic, confident, no photography behind it.',
    direction: 'Flat geometric composition in the Bauhaus tradition. Hard-edged circles, bars and quadrants of solid colour arranged around the product, which is cut out cleanly and placed as one more shape in the layout. No gradients, no photographic background, no depth.',
    typography: 'A geometric sans set large and aligned hard to the shapes, in one of the composition colours rather than plain white.',
    background: 'Solid blocks of flat colour dividing the frame. Absolutely flat, no lighting.',
    badges: false,
    fallbackPalette: 'primary red, blue and yellow on off-white',
    swatch: ['#EFEAE0', '#141414', '#D62828'],
    previewWeight: 800,
    previewSerif: false,
  },
  {
    ...
    family: 'Loud',
    previewShape: 'flat',
    blurb: 'Halftone dots, thick outlines, speech bubbles. Playful and very distinctive.',
    direction: 'Pop-art comic panel. Thick black outlines, flat fills, visible halftone dot shading and a burst shape behind the product. Reads as a printed comic frame, not a photograph with effects added.',
    typography: 'Heavy comic lettering inside a speech bubble or a jagged burst, slightly tilted.',
    background: 'Flat comic colour with halftone dots and optional radiating speed lines.',
    badges: true,
    fallbackPalette: 'comic red, yellow and cyan with heavy black line',
    swatch: ['#FFD93D', '#101010', '#E63946'],
    previewWeight: 900,
    previewSerif: false,
  },
  {
    ...
    family: 'Photographic',
    previewShape: 'photo',
    blurb: 'Rugged, outside, golden hour. Tools, gear, garden and camping.',
    direction: 'The product outdoors in real terrain: rock, dirt, timber, grass or a truck bed. Late golden-hour sun with long shadows and a real landscape falling away behind. Hard-wearing and unstyled.',
    typography: 'A sturdy condensed sans, slightly weathered, placed low against the ground rather than in the sky.',
    background: 'A real outdoor scene at golden hour, with depth and atmosphere.',
    badges: false,
    fallbackPalette: 'golden hour light, earth, timber and slate',
    swatch: ['#C4874B', '#2A2119', '#4A6B4A'],
    previewWeight: 700,
    previewSerif: false,
  },
  {
    id: 'kitchen',
    name: 'Food and kitchen',
    family: 'Photographic',
    previewShape: 'photo',
    blurb: 'Overhead flat lay on wood or marble. Cookware, food and anything edible.',
    direction: 'Overhead flat lay, shot straight down. The product on a wood, marble or linen surface with a few real ingredients or props arranged around it with space between them. Soft daylight from one side.',
    typography: 'A warm sans or light serif, small, tucked into an empty corner of the layout.',
    background: 'The surface itself, seen from directly above. Wood grain, marble or linen.',
    badges: false,
    fallbackPalette: 'warm wood, cream linen and one fresh ingredient colour',
    swatch: ['#E7D9C3', '#3B2F24', '#7A9A5B'],
    previewWeight: 500,
    previewSerif: true,
  },
  {
    ...
    family: 'Graphic',
    previewShape: 'grid',
    blurb: 'Line drawing on a technical field. Engineered, and unlike anything else here.',
    direction: 'Technical draughtsman\'s drawing. The product rendered as a precise line illustration, optionally exploded into its parts, with dimension arrows and annotation. Drawn rather than photographed.',
    typography: 'A small technical sans or monospace, all caps, sitting in a ruled title block at one edge.',
    background: 'A blueprint field: fine grid on deep cyan-blue, or black line on drafting white.',
    badges: false,
    fallbackPalette: 'blueprint cyan with white line, or white with fine black line',
    swatch: ['#13395E', '#DCE9F5', '#7FB2D9'],
    previewWeight: 500,
    previewSerif: false,
  },
  {
    ...
    family: 'Photographic',
    previewShape: 'photo',
    blurb: 'Shot on 35mm. Grain, soft highlights, slightly faded. Honest and warm.',
    direction: 'Photographed on 35mm film. Visible grain, gentle highlight roll-off, slightly lifted blacks and a faint colour cast. A real moment rather than a set-up, with the imperfect framing of a snapshot.',
    typography: 'A plain sans, small, placed like a caption at the edge of the frame or omitted where the photograph carries it alone.',
    background: 'Whatever was really behind it, shallow depth of field, natural light.',
    badges: false,
    fallbackPalette: 'faded film colour, warm cast, lifted shadows',
    swatch: ['#D8CFC0', '#4A423A', '#9C6F52'],
    previewWeight: 400,
    previewSerif: false,
  },
  {
    ...
    family: 'Graphic',
    previewShape: 'gradient',
    blurb: 'Soft blurred colour mesh, floating product. The modern software-brand look.',
    direction: 'Contemporary brand graphic. The product cut out and floating in a soft blurred gradient mesh, with a subtle glass or frosted panel behind it and a gentle glow. Smooth, digital and weightless.',
    typography: 'A clean modern sans in a medium weight, generously spaced, sometimes set inside the frosted panel.',
    background: 'A blurred multi-colour gradient mesh with no hard edges anywhere.',
    badges: false,
    fallbackPalette: 'violet into teal, soft and blurred',
    swatch: ['#6D5BD0', '#FFFFFF', '#3DC7C0'],
    previewWeight: 600,
    previewSerif: false,
  },
  {
    ...
    family: 'Quiet',
    previewShape: 'photo',
    blurb: 'No colour at all. Strong shapes and light. Stands out by refusing to.',
    direction: 'Black and white photography. No colour anywhere in the frame. The image works entirely on contrast, shape and the quality of the light, with deep blacks and clean whites.',
    typography: 'Type in pure black or pure white, one weight, set with real precision. No colour, not even an accent.',
    background: 'Monochrome. A plain ground or a real setting, both rendered without colour.',
    badges: false,
    fallbackPalette: 'pure greyscale, no accent colour of any kind',
    swatch: ['#1C1C1C', '#FAFAFA', '#8A8A8A'],
    previewWeight: 500,
    previewSerif: false,
  },
  {
    ...
    family: 'Loud',
    previewShape: 'paper',
    blurb: 'Layered cut-outs, tape and mixed texture. Zine energy, loud but hand-made.',
    direction: 'Hand-cut paper collage. Torn and scissor-cut layers of photograph, magazine print and coloured paper stacked with visible edges, tape and drop shadows. Deliberately rough and busy, assembled rather than designed.',
    typography: 'Ransom-note lettering cut from different sources, mismatched sizes and faces, pasted at angles.',
    background: 'Stacked paper and printed texture with visible torn edges.',
    badges: true,
    fallbackPalette: 'clashing printed colour on newsprint and kraft',
    swatch: ['#E3DCCB', '#1A1A1A', '#E8543F'],
    previewWeight: 800,
    previewSerif: true,
  },
  {
    ...
    family: 'Quiet',
    previewShape: 'photo',
    blurb: 'Pale wood, white walls, one plant. Calm and spacious.',
    direction: 'Nordic interior still life. Pale birch or ash, white walls, a linen or ceramic prop and a lot of empty space. Cool even daylight, no drama, everything in its place.',
    typography: 'A light geometric sans, small, in warm grey rather than black, with wide spacing around it.',
    background: 'A pale wood surface against a white wall, with soft even daylight.',
    badges: false,
    fallbackPalette: 'white, pale birch and cool grey with one sage accent',
    swatch: ['#F7F5F1', '#4A4742', '#9AAE9A'],
    previewWeight: 300,
    previewSerif: false,
  },
]
