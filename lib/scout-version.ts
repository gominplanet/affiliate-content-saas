 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.86'
...
export const SCOUT_WHATS_NEW =
  'Stamps every scan result with the SCOUT build that produced it, so a stale extension is obvious rather than confusing.'
