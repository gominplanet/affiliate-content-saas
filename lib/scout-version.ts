 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.85'
...
export const SCOUT_WHATS_NEW =
  'Picks up your video library where the last run stopped and keeps going, instead of restarting and timing out in the same place.'
