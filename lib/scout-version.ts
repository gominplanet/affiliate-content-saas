 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.64'
...
export const SCOUT_WHATS_NEW =
  'Reads far more of a large Amazon video library, and says how far it got instead of reporting a stalled crawl as the final count.'
