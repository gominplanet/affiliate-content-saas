 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.60'
...
export const SCOUT_WHATS_NEW =
  'Reads the per-product report when Amazon returns it as a table of columns and rows rather than a list of objects.'
