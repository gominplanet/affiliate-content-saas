 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.90'
...
export const SCOUT_WHATS_NEW =
  'Says how many videos are stored, and treats a finished library as finished instead of reporting it as a failure.'
