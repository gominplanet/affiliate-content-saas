 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.82'
...
export const SCOUT_WHATS_NEW =
  'Pages the per-product earnings report properly, so the product breakdown covers your month instead of a handful of rows.'
