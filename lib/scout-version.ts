 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.73'
...
export const SCOUT_WHATS_NEW =
  'Reads your Amazon video library from the page\u2019s own list API, paginated, instead of scraping what the page happens to render.'
