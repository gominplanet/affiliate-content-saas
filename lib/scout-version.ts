 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.63'
...
export const SCOUT_WHATS_NEW =
  'Reads every page of the per-product report and asks for it once per month, so figures are no longer counted twice.'
