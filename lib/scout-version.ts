 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.89'
...
export const SCOUT_WHATS_NEW =
  'Saves your video library in batches as it reads, using Amazon\u2019s own page size, so a large library actually lands.'
