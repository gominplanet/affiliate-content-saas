 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.72'
...
export const SCOUT_WHATS_NEW =
  'Skips Amazon\u2019s cart sidebar and recommendation strips when reading your video list, instead of refusing the page they sit on.'
