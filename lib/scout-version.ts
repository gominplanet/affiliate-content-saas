 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.79'
...
export const SCOUT_WHATS_NEW =
  'Works out how Amazon\u2019s video list paginates by testing it, so the whole library is read rather than the first ten.'
