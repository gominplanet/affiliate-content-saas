 ...
 */
export const SCOUT_LATEST_VERSION = '1.17.49'
...
export const SCOUT_WHATS_NEW =
  'The EPC load diagnostic now counts how many rows in each feed are genuinely opted in, instead of always reporting zero and making a healthy load look wrong.'
