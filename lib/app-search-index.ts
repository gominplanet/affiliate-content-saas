...
export const APP_SEARCH_INDEX: AppSearchEntry[] = [
  ...
  // ── Help & Community ─────────────────────────────────────────────────────
  { label: 'Storefront', href: '/brainstorm', group: 'Find & Earn', keywords: 'storefront analytics earnings sales revenue units clicks conversion best sellers amazon influencer scout' },
