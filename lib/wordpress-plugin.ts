/**
 * AffiliateOS WordPress plugin PHP code — shared between the setup wizard
 * (connect-and-setup) and the one-click installer (install-plugin).
 *
 * Both routes install the same snippet under the name 'AffiliateOS' so that
 * re-running setup or clicking "Install Plugin" in the dashboard always
 * updates the single snippet rather than creating duplicates.
 */

export const AFFILIATEOS_SNIPPET_NAME = 'AffiliateOS'

export const AFFILIATEOS_FULL_PHP = `
...
add_action('wp_footer', function () {
    ...
    (function(){
      ...
      d.innerHTML = '<a href="<?php echo $home; ?>" style="display:inline-block;line-height:0;"><img src="<?php echo $logo; ?>" alt="<?php echo $name; ?>" style="height:80px;width:auto;max-width:100%;object-fit:contain;" /></a>';
