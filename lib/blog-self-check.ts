...
11. GENERIC VERDICT-BOX OPENERS + SIGN-OFFS — the gr-verdict-text (Quick Verdict) and gr-sc-text (the Final Rating line folded into the scorecard) are the two most-anchored lines in the post and the most prone to AI-uniform phrasing. Flag any sentence INSIDE a <div class="gr-verdict-box"> or <div class="gr-sc-text"> that opens with or closes on these tells:
