        ...
        <div className="p-6">
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="w-3 h-3 rounded cursor-pointer accent-[#7C3AED]"
                    />
                    <span
          ...
          {selectedPlatforms.has('facebook') && fbAccounts.length > 1 && (
            <div className="mb-5">
              ...
              <select
                ...
                disabled={running}
                className="w-full text-xs px-2 py-1.5 rounded-lg bg-white dark:bg-[#1c1c1e] border border-gray-200 dark:border-white/10 focus:border-[#7C3AED] focus:outline-none"
              >
                {fbAccounts.map(a => (
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold text-white bg-[#7C3AED] hover:bg-[#6D28D9] disabled:opacity-50 transition-colors"
            >
              {running
