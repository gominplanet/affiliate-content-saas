...
const plans: PlanExt[] = [
  ...
  },
  {
    ...
    description: 'For the serious solo affiliate creator. Adds Telegram, scripts, Deals Hub, portrait (4:5) AI thumbnails, and weekly newsletter scheduling.',
    features: [
      ...
      'Portrait (4:5) AI thumbnails (face + product): 30 / month',
  ...
  },
  {
    ...
    features: [
      ...
      'Portrait (4:5) AI thumbnails: 100 / month',
