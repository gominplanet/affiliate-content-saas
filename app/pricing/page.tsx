...
const plans: PlanExt[] = [
  ...
  },
  {
    ...
    features: [
      '⚡ Publish from Deal Radar: quick-post deals, roundups & the weekly digest + shoppable Link-in-Bio page (browsing deals is free on every plan)',
  ...
  },
  {
    ...
    features: [
      ...
      'Everything in the Amazon Influencer plan too: 90 ready-to-post pins, 70 Reels covers & 45 Facebook designs / month, 90 Art Director thumbnails / month + Creator Connections brand deals',
      ...
      'MVP Help Desk: 400 messages / month',
  ...
  },
  {
    ...
    features: [
      ...
      'Everything in the Amazon Influencer plan too: 150 ready-to-post pins, 110 Reels covers & 80 Facebook designs / month, 120 Art Director thumbnails / month + Creator Connections brand deals',
      'Adds X (Twitter) auto-post on top of Studio, plus TikTok the moment it clears platform review',
      'Publish from Levanta + PartnerBoost: turn any campaign you find into a commissionable post (searching them is free on every plan)',
      ...
      '3 saved faces + 3 LoRA retrains / month, Photobooth 20 / month',
      'Video Script & Shot List (120 / month)',
      ...
      'MVP Help Desk: 800 messages / month',
      'Priority generation queue + priority support',
    ],
    highlight: false,
    ctaLabel: 'Get Pro',
    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0A0A0B] flex flex-col items-center px-4 py-16">
      ...
      <section className="mt-16 w-full max-w-6xl px-4">
        <div className="rounded-3xl p-6 sm:p-9" style={{ background: 'linear-gradient(180deg, rgba(234,88,12,0.10), rgba(234,88,12,0.03))', border: '1px solid rgba(234,88,12,0.30)' }}>
          ...
          {/* Every feature, explained. This is the "what it comes with" the buyer
            ...
            {[
              ...
              <div key={t.title} className="rounded-2xl bg-white dark:bg-[#1c1c1e] border border-gray-200 dark:border-white/10 p-5 flex flex-col">
                ...
                <div className="flex items-center justify-between gap-2 mb-1">
                  <p className="font-semibold text-[15px] text-[#1d1d1f] dark:text-[#f5f5f7]">{t.title}</p>
                  <span className="text-[11px] font-semibold whitespace-nowrap px-2 py-0.5 rounded-full" style={{ background: 'rgba(234,88,12,0.10)', color: '#C2410C' }}>{t.tag}</span>
                </div>
                <p className="text-[13px] leading-relaxed text-[#6e6e73] dark:text-[#ebebf0]">{t.desc}</p>
              </div>
            ))}
