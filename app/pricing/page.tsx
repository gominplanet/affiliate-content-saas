...
const plans: PlanExt[] = [
  ...
  // Creator and Studio are FROZEN (2026-09-15): the five existing subscribers
  // keep their plan, their price and their allowances, and nobody new can buy
  // one. Their cards are gone from here and from app/page.tsx, and checkout
  // refuses them outright, because removing the card alone leaves a bookmarked
  // /signup?plan=studio able to create a sixth account on a plan we decided not
  // to support.
  {
    tier: 'pro',
    label: 'Pro',
    ...
    features: [
      ...
      `${TIERS.pro.collabsPerMonth} brand pitches drafted for you / month`,
        ...
        <div className="rounded-3xl p-6 sm:p-9" style={{ background: 'linear-gradient(180deg, rgba(234,88,12,0.10), rgba(234,88,12,0.03))', border: '1px solid rgba(234,88,12,0.30)' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {[
              ...
              { icon: <MessageSquare size={20} />, title: 'Outreach written for you', tag: `${TIERS.amazon.collabsPerMonth} drafted pitches / month`, desc: 'MVP writes a personalised pitch from your brand profile and takes you straight to that brand\u2019s message box on Amazon. Message as many brands as you like; the monthly number is how many pitches MVP drafts for you.' },
