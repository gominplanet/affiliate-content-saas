...
const platforms = [
  ...
  { label: 'Twitter / X', status: 'roadmap' as const, color: '#000000' },
  { label: 'Bluesky',   status: 'roadmap' as const, color: '#1185fe' },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. Every draft is generated by Claude using your brand profile (tone, words to avoid, gear focus, affiliate disclosures). You should review every post before it publishes — we make that easy in the Studio.',
  },
  {
    ...
    <div className="min-h-screen bg-white text-[#1d1d1f]">
      ...
      <section className="pt-28 sm:pt-36 pb-12 sm:pb-20 px-5 sm:px-6 relative overflow-hidden bg-gradient-to-b from-[#f0f7ff] via-white to-white">
        ...
        <div className="relative max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-[#6e6e73] max-w-xl mx-auto lg:mx-0 mb-8 leading-relaxed">
              AI writes the review. We publish it to your WordPress site with our editorial theme.
      ...
      <section className="py-12 sm:py-16 border-y border-gray-100 bg-[#fafafa]">
        <div className="max-w-6xl mx-auto px-5 sm:px-6">
          <p className="text-center text-xs text-[#86868b] mb-6 uppercase tracking-widest font-semibold">
            ...
            {platforms.map(({ label, status, color }) => {
              ...
              return (
                <div key={label} className="flex flex-col items-center gap-2 p-3 rounded-xl bg-white border border-gray-100">
                  ...
                  <span className="text-[13px] font-semibold text-[#1d1d1f] text-center leading-tight">{label}</span>
                  <span className={`text-[10px] font-semibold uppercase tracking-wide px-2 py-0.5 rounded-full ${badge.bg} ${badge.fg}`}>
                    {badge.text}
                  </span>
                </div>
              )
          ...
          <p className="mt-6 text-center text-xs text-[#86868b] max-w-2xl mx-auto leading-relaxed">
            We only ship what works. Pinterest auto-publish is built and waiting on Pinterest&apos;s
            developer review. Twitter, Bluesky, and email digests are on the roadmap — no false promises.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 px-5 sm:px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-3">
            {faqs.map((f) => (
              <details key={f.q} className="group rounded-xl border border-gray-200 bg-white p-5 hover:border-[#0071e3]/40 transition-colors">
                <summary className="flex items-center justify-between cursor-pointer list-none">
                  <span className="text-base font-semibold text-[#1d1d1f]">{f.q}</span>
                  <span className="text-[#86868b] group-open:rotate-180 transition-transform">
                    <ArrowRight size={16} className="rotate-90" />
                  </span>
                </summary>
                <p className="mt-3 text-sm text-[#6e6e73] leading-relaxed">{f.a}</p>
              </details>
            ))}
          </div>
        </div>
  ...
  return (
    <div className="flex items-start gap-3 p-3 rounded-xl bg-white border border-gray-100 hover:border-[#0071e3]/30 transition-colors">
      ...
      <div className="flex-1">
        <p className="flex items-center gap-1.5 text-sm font-semibold text-[#1d1d1f]">
          <span className="text-[#0071e3]">{icon}</span>
          {title}
        </p>
        <p className="text-xs text-[#6e6e73] mt-0.5 leading-snug">{desc}</p>
      </div>
    </div>
  )
}
