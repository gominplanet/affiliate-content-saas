      ...
      <div className="card p-6 order-1">
        ...
        {facebook.connected ? (
          <div className="flex flex-col gap-3">
            ...
            {/* Self-service troubleshooter: wrong Page, missing Page, or a
                Business-Manager Page OAuth can't surface. Walks the user through
                their exact situation (the modernday.tech / Gina ticket). */}
            <FacebookFixHelper
              connected={facebook.connected}
              onConnected={(p) => setFacebook({ connected: true, pageId: p.id, pageName: p.name, pages: [p] })}
            />
