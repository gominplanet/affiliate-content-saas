      ...
      <div>
        ...
        {showTokenFallback && (
          <div className="mt-3 rounded-xl border border-gray-200 dark:border-white/10 bg-[var(--surface-2)] p-5">
            ...
            <a href="/api/download/plugin" download="mvpaffiliate-platform.zip" className="btn-secondary text-xs self-start inline-flex mb-3">
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="border-t border-gray-200 dark:border-white/10 pt-6 -mt-2">
        ...
        <div className="p-4 rounded-xl bg-[#f5f5f7] dark:bg-[#000] mb-3">
          ...
          <a href="/api/download/plugin" download="mvpaffiliate-platform.zip" className="btn-primary text-sm inline-flex">
