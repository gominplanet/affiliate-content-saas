      ...
      {loading ? (
        ...
        <div className="max-w-xl flex flex-col gap-5">
          ...
          <div className="card p-6">
            ...
            {/* Internal AI-cost guardrail intentionally NOT surfaced here — users
                should only ever see their content-piece allowance (the meter
                above), never underlying AI cost/spend. The circuit breaker still
                runs server-side (lib/ai-spend.ts); it's just invisible in the UI. */}
          </div>
