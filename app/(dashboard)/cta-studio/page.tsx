...
//
// CTA Studio — the "MVP as origin" upload path. Upload a finished horizontal
// video, burn a branded call-to-action onto it (lower third or end card, like
// Clip Factory does for Shorts), preview it, download it, and publish it
// straight to YouTube. In LABS while we test the full upload pipeline.
'use client'
...
export default function CtaStudioPage() {
  ...
  async function onPick(file: File) {
    ...
    try {
      ...
      if (dims.width > 0 && dims.height > 0 && dims.height > dims.width) {
        toast.error('This looks vertical. CTA Studio is for horizontal videos — use Clip Factory for Shorts.')
  ...
  return (
    <>
      <PageHero
        title="CTA Studio"
        subtitle="Upload a horizontal video, burn in a branded call-to-action, and publish it to YouTube. The upload path that starts everything inside MVP."
      />

      <div className="max-w-2xl space-y-6 pb-28">
        {/* 1. Upload */}
        <div className="card p-5">
          <h2 className="text-sm font-semibold mb-3" style={label}>1. Upload your video</h2>
        ...
        {/* 2. CTA */}
        <div className="card p-5">
          <h2 className="text-sm font-semibold mb-3" style={label}>2. Design the CTA</h2>
        ...
        {rendered && (
          <div className="card p-5">
            <h2 className="text-sm font-semibold mb-3" style={label}>3. Preview & publish</h2>
