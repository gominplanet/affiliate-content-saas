  ...
  return (
    <>
      <PageHero
        ...
        subtitle="For a video that is not on YouTube yet. Upload it once and MVP finishes it with the Co-Pilot, burns in your CTA, publishes to YouTube, then takes the clean copy to your Amazon storefronts. Videos already on your channel are handled on Storefront Sync, which works through your whole catalogue on its own."
      />
