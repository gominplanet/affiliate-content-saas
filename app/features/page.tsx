...
const GROUPS: { id: string; n: string; tag: string; head: string; intro: string; items: Feat[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: <Rocket size={20} />, tag: 'Pro', title: 'Launchpad', desc: "Start from a video that isn't on YouTube yet. Upload it once, add a CTA, and MVP takes it to YouTube with the full Co-Pilot finish, then straight to your English Amazon storefronts: US, Canada, UK and Australia." },
